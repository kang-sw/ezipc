...
template <ClientConnector Conn_, StreamCodec Codec_ = default_stream_codec, class Alloc_ = std::allocator<byte>>
class ipc_client
    : internal::ipc_client_base
    , public std::enable_shared_from_this<ipc_client<Conn_, Codec_, Alloc_>>
{
public:
    using connection_argument_type = typename Conn_::connection_argument_type;
