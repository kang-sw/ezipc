...
#ifndef EZIPC_COMPILE_TIME_MUTED_VERBOSITY
/**
 * Adjust log verbosity which will be optimized during compilation
 */
#define EZIPC_COMPILE_TIME_MUTED_VERBOSITY none
#endif
...
public:
    ...
    {
        if constexpr (static_verbosity > logger_verbosity::EZIPC_COMPILE_TIME_MUTED_VERBOSITY) {
